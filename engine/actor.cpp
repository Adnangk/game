...
void Actor::change_direction(const Vec& dir) { direction = dir; }
...
const Vec& Actor::get_position() const { return position; }
...
void Actor::take_damage(int amount) { health -= amount; }
